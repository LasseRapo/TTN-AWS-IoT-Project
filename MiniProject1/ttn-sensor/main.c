...
static const uint8_t deveui[LORAMAC_DEVEUI_LEN] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x2B, 0xC4 };
static const uint8_t appkey[LORAMAC_APPKEY_LEN] = { 0xAE, 0x26, 0xBB, 0x0D, 0x45, 0xE3, 0xB3, 0x6A, 0xEB, 0xF9, 0xE4, 0x49, 0xA6, 0x86, 0x07, 0x82 };
